...
public class Exercise2Test {
    ...
    public void mergeValues() {
         ...
         */
        BiFunction<Integer, Integer, Integer> sumUpOldAndNewValue = (oldValue, newValue) -> oldValue + newValue;
        map.merge("Alice", 32, sumUpOldAndNewValue);
        map.merge("Joe", 32, sumUpOldAndNewValue);
    ...
    public void ignoringAbsentKeys() {
         ...
         */
        BiFunction<Object, Integer, Integer> increaseValue = (key, value) -> value + 1;
        map.computeIfPresent("Joe", increaseValue);
        map.computeIfPresent("Steven", increaseValue);
        map.computeIfPresent("Alice", increaseValue);
